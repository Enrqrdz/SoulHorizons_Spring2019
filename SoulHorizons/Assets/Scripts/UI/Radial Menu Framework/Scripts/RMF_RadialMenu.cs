...
public class RMF_RadialMenu : MonoBehaviour {
    ...
    void Update() {
        ...
        //==============================================================================================
        bool joystickMoved = Input.GetAxis("J_SecondHorizontal") != 0.0 || Input.GetAxis("J_SecondVertical") != 0.0;
        //==============================================================================================
        ...
        if (!useGamepad)
            ...
            rawAngle = Mathf.Atan2(Input.GetAxis("J_SecondVertical"), Input.GetAxis("J_SecondHorizontal")) * Mathf.Rad2Deg;
        ...
        if (angleOffset != 0 && useLazySelection) {
            ...
            if (elements[index] != null) {
                ...
                else //no movement on either axis of the joystick
                {
                    //deselect all buttons
                    foreach (RMF_RadialMenuElement item in elements)
                    {
                        item.unHighlightThisElement(pointer); //deselect the button
                    }
                }
            }
