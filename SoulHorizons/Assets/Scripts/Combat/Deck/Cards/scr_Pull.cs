...
public class scr_Pull : CardData
{
    public AttackData pullAttack;
    ...
    public override void Activate()
    {
        ...
        scr_AttackController.attackController.AddNewAttack(pullAttack, player._gridPos.x, player._gridPos.y, player);
    }
